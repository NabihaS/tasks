...
export function toMarkdown(question: Question): string {
    //how to show each elements in an array?
    //use join and then \n to modify array of options
...
export function publishQuestion(question: Question): Question {
    const invpublished = !question.published;
    return { ...question, published: invpublished };
}
 ...
 */
//create new question using makeBlank orrrr copy over question?
